...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    secondary:
      "px-4 py-3 text-sm md:px-6 md:py-4 inline-block border-2 border-stone-300 rounded-full hover:bg-stone-300 hover:text-stone-800 focus:text-stone-800 font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-300 focus:bg-stone-300 focus:outline-none focus:ring focus:ring-stone-300 focus:ring-offset-2 disabled:cursor-not-allowed",
  };
